...
class balanceController {
    ...
    async createCheckoutSession(req, res) {
        try {
            ...
            return ResponseHelper.success(res, { url: session.url }, 'Checkout session created successfully');
        } catch (error) {
            return ResponseHelper.error(res, error.message);
        }
    }
    ...
    async handleWebhook(req, res) {
        try {
            ...
            return ResponseHelper.success(res, null, 'Webhook processed successfully');
        } catch (error) {
            return ResponseHelper.error(res, error.message);
        }
    }
